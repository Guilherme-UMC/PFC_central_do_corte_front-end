...
const STATUS_CONFIG = {
  ...
  'Cancelado pelo cliente': { label: 'Cancelado pelo cliente', className: 'status-badge status-badge--cancelled' },
  ...
  CONFIRMADO: { label: 'Confirmado', className: 'status-badge status-badge--confirmed' },
  CANCELADO_PELO_CLIENTE: { label: 'Cancelado pelo cliente', className: 'status-badge status-badge--cancelled' },
